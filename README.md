...
- Go to the [SWOW research page](https://smallworldofwords.org/en/project/research) [2] and download the English processed data (SWOW-EN18). Save this .csv file in the "reproducibility/data/original_datasets" folder.
...
### References
[1] _Abramski, K., et al. (2024). The" LLM World of Words" English free association norms generated by large language models. arXiv preprint arXiv:2412.01330._
