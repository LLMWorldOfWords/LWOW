...
with open("mistral_hypernyms.jsonl", "w") as f:
    for profile in tqdm.tqdm(profiles):
        ...
        prompt = f"""
                ...
                Task:
                 - You will be provided with an input word and a specific context (within parentheses): write the word hypernyms related to the specified context.
                ...
                Output: flower * plant 
                 ...
                 Constraints:
                 - Separe consecutive hypernyms with an asterisk (*). Other separators will be considered incorrect.
                 - Avoid enumerating the hypernyms.
                 - Do not explain the hypernyms nor the task.
                 - An hypernyms is a word whose meaning includes the meanings of other words. For instance, "flower" is a hypernym of "daisy" and "rose".
                 - Each hypernyms should be a single word.
                 ...
                 - In case of no hypernyms, leave the response empty.
